...
export const profile: Profile = {
  ...
  narrative: {
    ...
    paragraphs: [
      ...
      'Now completing my Master of Information Technology at UNSW Sydney (WAM 83, Distinction average), I focus deeply on Applied AI and distributed backend infrastructure. Through research at UNSW and engineering internships at NodesNow, I have designed and shipped durable event-driven ingestion engines with Inngest and GraphRAG knowledge engines with Neo4j and pgvector.',
      'Graduating in December 2026, I am actively seeking full-time opportunities in Applied AI Engineering, Agentic Systems, and Backend Infrastructure where reliable, high-scale architecture matters.',
    ],
  },
  summary:
